...
import de.tosox.modbrew.domain.port.ArchiveDownloader;
import de.tosox.modbrew.domain.port.DownloadResult;
import de.tosox.modbrew.infrastructure.download.source.UrlSource;
import de.tosox.modbrew.shared.logging.Logger;
import de.tosox.modbrew.shared.progress.ProgressInputStream;
import de.tosox.modbrew.shared.progress.ProgressListener;
import de.tosox.modbrew.shared.util.HashUtils;
